...
from django.views.generic import View, CreateView, TemplateView, FormView, UpdateView, ListView
...
class IndexView(CreateView, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        print("followers count of logged user", lst.count(self.request.user))
